...
<center>Profesor: Angela Augusto Velasquez Nuñez</center> 
...
**Técnica 5Ws y 2Hs**
| Who?      | ¿Quiénes están involucrados?    | Empresarios y transportistas que necesitan gestionar flotas de transporte en diversos ámbitos empresariales. |
|---------------------------------------------|---------------------------------------------|-------------------------------------------------------------------------------------------------------------|
...
| Where?    | ¿Dónde surge el problema?       | En empresas que operan flotas de transporte en diferentes sectores y ubicaciones geográficas. |
| When?     | ¿Cuándo sucede el problema?     | En un contexto donde la gestión eficiente de flotas es crucial para la rentabilidad y competitividad empresarial, y donde la falta de herramientas adecuadas puede generar pérdidas financieras y daños a la reputación. |
...
|---------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------|
| Dominio (Domain)          | La gestión de flotas de transporte en diversos ámbitos empresariales requiere un enfoque integral y eficiente.                                           |
| Segmentos de clientes     | Empresarios y transportistas se enfrentan a dificultades debido a la falta de herramientas especializadas.                                               |
| Pain points               | La gestión manual de vehículos y rutas resulta propensa a errores y consume tiempo y recursos.                                                           |
| Gap                       | La falta de un sistema centralizado dificulta la optimización de la eficiencia operativa y la toma de decisiones informadas.                             |
| Visión/Strategy           | La necesidad de una solución integral y eficiente para la gestión de flotas en el sector del transporte empresarial.                                     |
| Segmento inicial          | Empresarios y transportistas que operan flotas de transporte en diferentes sectores y ubicaciones geográficas.                                           |
